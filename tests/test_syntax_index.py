...
from local_code_context.syntax.detection import detect_language  # noqa: E402
from local_code_context.syntax.indexer import (  # noqa: E402
    MAX_SIGNATURE_CHARS,
    BuildResult,
    ParseQuality,
    build_index_records,
...
from local_code_context.syntax.extraction import (  # noqa: E402
    PythonTagQueryExtractor,
    load_python_tags_query,
)
from local_code_context.syntax.parsers import ParserRegistry  # noqa: E402
...
class SyntaxIndexTests(unittest.TestCase):
    ...
    def test_lazy_parser_loading(self) -> None:
        ...
        with patch(
            "local_code_context.syntax.parsers._build_python_parser",
    ...
    def test_parser_registry_retains_language(self) -> None:
        ...
        with (
            ...
            patch(
                "local_code_context.syntax.parsers._build_python_language",
    ...
    def test_query_mode_matches_legacy_records_when_captures_match(self) -> None:
        ...
        with patch.dict(
            "local_code_context.syntax.indexer.QUERY_EXTRACTORS",
